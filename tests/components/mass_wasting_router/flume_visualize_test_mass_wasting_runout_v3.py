...
mg = RasterModelGrid((r_,c_+2),dxdy)
ycol = np.reshape(mg.node_y,(r_,c_+2))[:,0]
yn = np.arange(r_)
yeL = []
...
plt.savefig("WideFlume.png", dpi = 300, bbox_inches='tight')
...
plt.savefig(pdir+"WideFlume_FlowDirections.png", dpi = 300, bbox_inches='tight')
...
s_mg = RasterModelGrid((r_,c_+2), dxdy)

# plot how slope changes
