# -*- coding: utf-8 -*-
def plot_node_field_with_shaded_dem_Arc(mg, mg_hs, field, save_name= None, plot_name = None, figsize = (12,9.5), 
    ...
    imshow_grid_at_node(mg_hs, 'hillshade_arc', cmap='Greys_r',
    ...
    fig = imshow_grid_at_node_jk(mg, field, cmap= cmap,
                      grid_units=('coordinates', 'coordinates'),
...
def imshow_grid_at_node_jk(grid, values, **kwds):
    ...
    *values* can be a field name, a regular array, or a masked array. If a
    ...
    _imshow_grid_values_(grid, values_at_node.reshape(shape), **kwds)
