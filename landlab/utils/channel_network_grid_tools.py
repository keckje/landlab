...
class ChannelNetworkGridTools(Component):    
    ...
    class 1: ChannelNetworkToolsInterpretor
        -   extract_channel_nodes
            extract_terrace_nodes
            min_distance_to_network
    
    class 2: ChannelNetworkToolsMapper
            map_nmg_links_to_rmg_nodes
            map_nmg1_links_to_nmg2_links
            map_rmg_nodes_to_nmg_nodes
            transfer_rmg_node_field_to_nmg_node_field
