...
class MassWastingRunoutProbabilityBase(Component):
    ...
    def __init__(
        ...
        self.plot = plot
        self._vary_landslide_area = vary_landslide_area  
    ...
    def _monte_carlo_runout(self):
        ...
        for i in range(self.ni):
            ...
            # check that qsc is high enough => may not need this anymore
            # PASS = False
            # while PASS is False :
            #     MWR.SD = np.random.uniform(0.05,0.15)
            #     if MWR.SD > MWR.cs:
            #         PASS = True
