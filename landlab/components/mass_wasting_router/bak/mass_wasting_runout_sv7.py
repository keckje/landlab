...
class MassWastingRunout(Component):
    ...
    itL = 1000):
        ...
        # set run options
        self.opt1_b = True # use different critical slope?
        self.opt2_b = True # use dem+df surface to route?
        self.opt3_b = True # use downslope cell hieght to set minimum deposit?
