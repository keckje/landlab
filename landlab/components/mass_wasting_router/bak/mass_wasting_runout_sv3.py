...
class MassWastingRunout(Component):
    ...
    def _scour_entrain_deposit(self):
        ...
        self._grid.at_node['topographic__elevation_mw'] = self._grid.at_node['topographic__elevation'].copy()
        ...
        for i,inn in enumerate(innL):
            ...
            while len(arn)>0 and c < self.itL:
                ...
                for n in np.unique(arn):
                    ...
                    self._grid.at_node['topographic__elevation_mw'][n] = self._grid.at_node['topographic__elevation'][n]+df_depth
                ...
                if self.save:
                    ...
                    # save precipitions
                    self.df_th_maps[i][c] = self._grid.at_node['topographic__elevation_mw'].copy()
