...
class LandslideMapper(Component):
    ...
    fields of topographic elevation and landslide factor of saftey or landslide 
    probability and outputs a table and raster model grid fields that indicate
    landslide location and summarize the attributes of each mapped landslide
    ...
    _info = {
        ...
        'mass__wasting_potential': {            # generic field name for 'high__MW_probability' "factor of safety"
            "dtype": float,
            "intent": "in",
            "optional": False,
            "units": "-",
